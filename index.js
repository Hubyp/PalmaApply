const webhookURL = "https://discord.com/api/webhooks/1076231682518175925/_rvfO8AcL0-OFrZbsdvfSRTcLLqxLRItJNKNt_QFdtdzis4xVzzMABl1d6j-aLK3iiPi" // MANDATORY | Your Webhook URL Here
const avatarURL = "https://cdn.discordapp.com/attachments/972489263230910464/1074957478351097926/IMG_0309.jpg" // OPTIONAL | The URL for the PFP of the webhook itself. Must be a link to a supported image format.
...
function sendMessage() { // After submitting the form.
    ...
    var embed = { // Embed to send.
        ...
        title: "New Satff Appeal!", // Title of the embed
        timestamp: new Date(), // Footer Timestamp of the embed
        color: 0xFF0000, // Color of the embed
        footer: { text: `Satff Apply | User ID: ${(userID.value).toString()}` }, // Footer of the embed
        fields: [ // Fields of the embed
            ...
            { name: "Reason for you want in Staff", value: `${reason.value}` },
            { name: "Appeal", value: `${appeal.value}` }
        ]
    }

    var params = { // Parameters to send the request
        username: `Staff Apply`, // Name of the webhook
    ...
    alert('Satff Apply Sent!') // Tells the user that the appeal has been sent.
    console.log('Satff Apply Sent!') // Logs that the appeal has been sent. (For DEVELOPMENT purposes)
}
